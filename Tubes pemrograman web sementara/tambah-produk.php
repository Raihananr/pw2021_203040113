...
<body>
    ...
    <header>
        <div class="container">
            <h1><a href="dashboard.php">RebelStore</a></h1>
            <ul>
            ...
            <div class="box">
                ...
                <?php 
                    if(isset($_POST['submit'])){
                        ...
                        //menampung data file yang di perbolehkan
                        $tipe_diizinkan = array('png', 'jpg', 'jpeg', 'git');

                        //validasi format file
                        if(!in_array($type2, $tipe_diizinkan)){
                            echo '<script>alert("Format file tidak diizinkan")</script>';
                        }else{
                            //jika format file sesuai dengan yang ada
                            //proses upload sekalian insert ke data base
